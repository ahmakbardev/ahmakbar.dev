    ...
    <section ref={ref} className="relative h-screen w-screen overflow-hidden">
      {services.map((s, i) => (
        <motion.div
          ...
          className="service-card absolute left-1/2 top-1/2 w-64 p-5 bg-white rounded-3xl shadow-xl -translate-x-1/2 -translate-y-1/2 flex flex-col gap-4 cursor-pointer"
        >
      ...
      <motion.h1
        ...
        className="absolute left-[23%] md:left-[39%] top-1/2 -translate-x-1/2 -translate-y-1/2 text-center text-4xl font-bold text-white"
      >
